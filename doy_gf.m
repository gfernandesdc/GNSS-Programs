...
% inp_epoch= sscanf(epc,'%d',3);
% y   = inp_epoch(1); % Year with four digits
% m   = inp_epoch(2);
% d   = inp_epoch(3);
% h   = inp_epoch(4);
% min = inp_epoch(5);
